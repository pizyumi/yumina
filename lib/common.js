...
obj = _.extend(obj, {
  ...
  load_stats_from_path: async (p) => {
    try {
      return await fs.statAsync(p);
    }
    catch (err) {
      return null;
    }
  ...
  load_text_from_path_empty: async (p) => {
    try {
      return await obj.load_text_from_path(p);
    }
    catch (err) {
      return '';
    }
  ...
  load_json_from_path_empty_object: async (p) => {
    try {
      return await obj.load_json_from_path(p);
    }
    catch (err) {
      return {};
    }
  },
  load_json_from_path_empty_array: async (p) => {
    try {
      return await obj.load_json_from_path(p);
    }
    catch (err) {
  ...
  copy_folder_from_path_to_path: async (p1, p2) => {
    await fsextra.copyAsync(p1, p2);
  },
  remove_file_from_path: async (p) => {
    await fsextra.removeAsync(p);
  }
});
